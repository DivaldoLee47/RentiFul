  ...
  return (
    <div className="relative py-24">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative max-w-4xl xl:max-w-6xl mx-auto px-6 sm:px-6 lg:px-12 xl:px-16 py-12"
      >
        <div className="flex flex-col md:flex-row justify-center items-center">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start gap-4">
              ...
              <Link
                href="/signup"
                className="inline-block text-white bg-secondary-500 rounded-lg px-6 py-3 font-semi-bold hover:bg-secondary-600"
                scroll={false}
              >
                Sign Up
              </Link>
